...
class FormatController extends Controller
{
    ...
    public function updateFormat(Request $request)
    {
        ...
        $format = Format::where('format_name', '=', $request->format_name)->first();
        if (!$format) {
        ...
        Format::where('format_name', '=', $format->format_name)->update($updated_data);
    ...
    public function deleteFormat(Request $request)
    {
        ...
        Format::where('format_name', '=', $request->format_name)->delete();
