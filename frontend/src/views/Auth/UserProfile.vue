...
<template>
    ...
    <main class="wrapper">
        ...
        <div class="hrefs">
            <p>
                <RouterLink class="locallink" :to="{ path: '/UserCards', query: { user: id } }">Коллекция пользователя
                    {{ user.login }}</RouterLink>
            </p>
            <p>
                <RouterLink class="locallink" :to="{ path: '/UserDecks', query: { user: id } }">Колоды пользователя {{
                    user.login }}</RouterLink>
            </p>
            <p>
                <RouterLink class="locallink" :to="{ path: '/UserLots', query: { user: id } }">Объявления пользователя {{
                    user.login }}</RouterLink>
            </p>
        </div>
