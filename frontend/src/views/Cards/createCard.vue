...
function submitFunction(event) {
    ...
    axios.post('http://localhost:8000/Card', {
        ...
        "subtypes": createForm.subtypes,
        "supertypes": createForm.supertypes,
        ...
        .then(result => {
            addMesage('Карта успешно создана');
        })
        .catch(error => {
...
<template>
    ...
    <main class="wrapper">
        ...
        <form @submit="submitFunction" class="inputForm">
            ...
            <input class="input" type="text" placeholder="Автор иллюстрации" v-model="createForm.illustration_author">
